...
uses
 ...
 WinApi.Windows,
  ...
  BookBO in 'BusinessObjects\BookBO.pas',
  BooksControllerU in 'Controllers\BooksControllerU.pas',
  BooksModuleU in 'Modules\BooksModuleU.pas' {PeopleModule: TDataModule};
